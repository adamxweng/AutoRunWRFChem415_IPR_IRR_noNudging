...
&time_control
 ...
 auxhist9_outname  = "./IRR_DIAG_d<domain>_<date>_201_base415_noPBLnudging"
 auxhist9_interval = 60, 60
 frames_per_auxhist9 = 24, 1 !output frame, 24 hours a file
 io_form_auxhist9    = 2
 history_outname = './wrfout_d<domain>_<date>_201_base415_noPBLnudging'
 /
 ...
 chem_opt                            = 201, 202, 202,             ! chemistry option, 201 = MOZART-MOSAIC (4 bins + simplified SOA + no aqeuous chemistry), 202 = MOZART-MOSAIC (4 bins + VBS SOA + aqeuous chemistry).
